    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    var korisnik = db.Korisniks.Find(model.UserName);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                korisnik.ID_korisnika = model.UserName;
                korisnik.Sifra = model.Password;
                korisnik.Ime = model.Ime;
                korisnik.Prezime = model.Prezime;
                
                gledalac.Datum_registracije = System.DateTime.Now;
               gledalac.ID_korisnika = model.UserName;
               korisnik.Gledalac = gledalac;
  
                
                db.Korisniks.Add(korisnik);
                db.Gledalacs.Add(gledalac);
